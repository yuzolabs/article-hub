...
tags:
  ...
  - git
  - worktree
updated_at: '2025-11-17T15:01:56.263Z'
id: null
...
![ワークツリーメニュー](https://raw.githubusercontent.com/yuzolabs/article-hub/main/images/2025/11/vscode-git-worktree/worktree-menu.png)

3. ブランチ選択画面が出るので、新規作成するブランチ名を決めるか、既存のブランチを選択します。
   既存のブランチを使用する場合の一例としてリモートブランチにあるものを選択することで、**PRのレビューに使用できます**。

![ブランチ指定画面](https://raw.githubusercontent.com/yuzolabs/article-hub/main/images/2025/11/vscode-git-worktree/worktree-branch-select.png)

![ブランチ作成画面](https://raw.githubusercontent.com/yuzolabs/article-hub/main/images/2025/11/vscode-git-worktree/worktree-branch-create.png)

その後にワークツリーの作成先を指定する画面が表示されますが、基本的にデフォルトのままにすることをおすすめします。

![ワークツリー作成画面](https://raw.githubusercontent.com/yuzolabs/article-hub/main/images/2025/11/vscode-git-worktree/worktree-location-select.png)
...
![worktree一覧画面](https://raw.githubusercontent.com/yuzolabs/article-hub/main/images/2025/11/vscode-git-worktree/worktree-list.png)
...
![削除前メッセージ](https://raw.githubusercontent.com/yuzolabs/article-hub/main/images/2025/11/vscode-git-worktree/worktree-delete-confirm.png)
